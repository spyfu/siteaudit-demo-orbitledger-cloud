...
$expectedRepository = 'spyfu/siteaudit-demo-orbitledger-cloud'
$expectedRemoteHttps = 'https://github.com/spyfu/siteaudit-demo-orbitledger-cloud.git'
$expectedRemoteSsh = 'git@github.com:spyfu/siteaudit-demo-orbitledger-cloud.git'
